...
def dict_to_xml(d):
    ...
    xml_resource.attrib[
        "xsi:schemaLocation"
    ] = "http://datacite.org/schema/kernel-4 https://schema.datacite.org/meta/kernel-4.4/metadata.xsd"
    ...
    if relatedIdentifiers:
        ...
        for relatedIdentifier in relatedIdentifiers:
            if relatedIdentifier["related_identifier"]:
                xml_related_identifier = ET.SubElement(
                    xml_related_identifiers, "relatedIdentifier"
                )
                xml_related_identifier.text = relatedIdentifier["related_identifier"]
                xml_related_identifier.attrib[
                    "relatedIdentifierType"
                ] = relatedIdentifier["related_identifier_type"]
                xml_related_identifier.attrib["relationType"] = relatedIdentifier[
                    "related_identifier_relation_type"
                ]
    ...
    if creators:
        for creator in creators:
            ...
            try:
                ...
                orcid = None
            if orcid:
                xml_creator_name_identifier = ET.SubElement(
                    xml_creator, "nameIdentifier"
                )
